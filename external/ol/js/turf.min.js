!function(t){
	...
	else if("function"==typeof define&&define.amd)define([],t);else{var e;
		e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,e.turf=t()}
	}(function(){
		var t;
		return function t(e,n,i){function r(s,a){
			if(!n[s]){if(!e[s]){var u="function"==typeof require&&require;
			if(!a&&u)return u(s,!0);if(o)return o(s,!0);var l=new Error("Cannot find module '"+s+"'");
			throw l.code="MODULE_NOT_FOUND",l}var c=n[s]={exports:{}};e[s][0].call(c.exports,
				function(t){var n=e[s][1][t];return r(n||t)},c,c.exports,t,e,n,i)}return n[s].exports}
			for(var o="function"==typeof require&&require,s=0;s<i.length;s++)r(i[s]);return r}
				({1:[function(t,e,n){var i=t("@turf/helpers"),r=t("@turf/invariant"),o=t("@turf/meta"),s=t("@turf/clusters"),
					a={isolines:t("@turf/isolines"),convex:t("@turf/convex"),within:t("@turf/within"),concave:t("@turf/concave"),
					difference:t("@turf/difference"),dissolve:t("@turf/dissolve"),collect:t("@turf/collect"),flip:t("@turf/flip"),
					simplify:t("@turf/simplify"),bezier:t("@turf/bezier"),tag:t("@turf/tag"),sample:t("@turf/sample"),
					envelope:t("@turf/envelope"),square:t("@turf/square"),circle:t("@turf/circle"),
					midpoint:t("@turf/midpoint"),buffer:t("@turf/buffer"),center:t("@turf/center"),
					centerOfMass:t("@turf/center-of-mass"),
					centroid:t("@turf/centroid"),combine:t("@turf/combine"),distance:t("@turf/distance"),
					explode:t("@turf/explode"),bbox:t("@turf/bbox"),tesselate:t("@turf/tesselate"),
					bboxPolygon:t("@turf/bbox-polygon"),inside:t("@turf/inside"),intersect:t("@turf/intersect"),
					nearest:t("@turf/nearest"),planepoint:t("@turf/planepoint"),random:t("@turf/random"),
					tin:t("@turf/tin"),union:t("@turf/union"),bearing:t("@turf/bearing"),destination:t("@turf/destination"),
					kinks:t("@turf/kinks"),pointOnSurface:t("@turf/point-on-surface"),area:t("@turf/area"),
					along:t("@turf/along"),lineDistance:t("@turf/line-distance"),lineSlice:t("@turf/line-slice"),
					lineSliceAlong:t("@turf/line-slice-along"),pointOnLine:t("@turf/point-on-line"),
					pointGrid:t("@turf/point-grid"),squareGrid:t("@turf/square-grid"),
					triangleGrid:t("@turf/triangle-grid"),hexGrid:t("@turf/hex-grid"),
					idw:t("@turf/idw"),truncate:t("@turf/truncate"),flatten:t("@turf/flatten"),
					lineIntersect:t("@turf/line-intersect"),mask:t("@turf/mask"),lineChunk:t("@turf/line-chunk"),
					unkinkPolygon:t("@turf/unkink-polygon"),greatCircle:t("@turf/great-circle"),
					lineSegment:t("@turf/line-segment"),lineSplit:t("@turf/line-split"),lineArc:t("@turf/line-arc"),
					polygonToLineString:t("@turf/polygon-to-linestring"),lineStringToPolygon:t("@turf/linestring-to-polygon"),
					bboxClip:t("@turf/bbox-clip"),lineOverlap:t("@turf/line-overlap"),sector:t("@turf/sector"),
					rhumbBearing:t("@turf/rhumb-bearing"),rhumbDistance:t("@turf/rhumb-distance"),
					rhumbDestination:t("@turf/rhumb-destination"),polygonTangents:t("@turf/polygon-tangents"),
					rewind:t("@turf/rewind"),isobands:t("@turf/isobands"),transformRotate:t("@turf/transform-rotate"),
					transformScale:t("@turf/transform-scale"),transformTranslate:t("@turf/transform-translate"),
					lineOffset:t("@turf/line-offset"),polygonize:t("@turf/polygonize"),booleanDisjoint:t("@turf/boolean-disjoint"),
					booleanContains:t("@turf/boolean-contains"),booleanCrosses:t("@turf/boolean-crosses"),
					booleanClockwise:t("@turf/boolean-clockwise"),booleanOverlap:t("@turf/boolean-overlap"),
					booleanPointOnLine:t("@turf/boolean-point-on-line"),booleanEqual:t("@turf/boolean-equal"),
					booleanWithin:t("@turf/boolean-within"),clone:t("@turf/clone"),cleanCoords:t("@turf/clean-coords"),
					interpolate:t("@turf/interpolate"),clustersDbscan:t("@turf/clusters-dbscan"),clustersKmeans:t("@turf/clusters-kmeans"),
					pointToLineDistance:t("@turf/point-to-line-distance"),getCluster:s.getCluster,
					clusterEach:s.clusterEach,clusterReduce:s.clusterReduce,point:i.point,polygon:i.polygon,
					lineString:i.lineString,multiPoint:i.multiPoint,multiPolygon:i.multiPolygon,multiLineString:i.multiLineString,
					feature:i.feature,geometry:i.geometry,featureCollection:i.featureCollection,geometryCollection:i.geometryCollection,
					radiansToDistance:i.radiansToDistance,distanceToRadians:i.distanceToRadians,distanceToDegrees:i.distanceToDegrees,
					bearingToAngle:i.bearingToAngle,degrees2radians:i.degrees2radians,radians2degrees:i.radians2degrees,
					convertDistance:i.convertDistance,isNumber:i.isNumber,
					round:i.round,convertArea:i.convertArea,getCoord:r.getCoord,getCoords:r.getCoords,geojsonType:r.geojsonType,
					featureOf:r.featureOf,collectionOf:r.collectionOf,containsNumber:r.containsNumber,
					getGeom:r.getGeom,getGeomType:r.getGeomType,coordEach:o.coordEach,coordReduce:o.coordReduce,
					propEach:o.propEach,propReduce:o.propReduce,featureEach:o.featureEach,featureReduce:o.featureReduce,
					coordAll:o.coordAll,geomEach:o.geomEach,geomReduce:o.geomReduce,flattenEach:o.flattenEach,
					flattenReduce:o.flattenReduce,segmentReduce:o.segmentReduce,segmentEach:o.segmentEach,
					lineEach:o.lineEach,lineReduce:o.lineReduce};e.exports=a},
					{
						"@turf/along":2,"@turf/area":12,"@turf/bbox":22,"@turf/bbox-clip":16,"@turf/bbox-polygon":20,"@turf/bearing":24,
						"@turf/bezier":26,"@turf/boolean-clockwise":29,"@turf/boolean-contains":31,
						"@turf/boolean-crosses":39,"@turf/boolean-disjoint":61,"@turf/boolean-equal":82,
						"@turf/boolean-overlap":91,"@turf/boolean-point-on-line":157,"@turf/boolean-within":159,
						"@turf/buffer":167,"@turf/center":206,"@turf/center-of-mass":177,"@turf/centroid":210,
						"@turf/circle":213,"@turf/clean-coords":218,"@turf/clone":221,"@turf/clusters":242,
						"@turf/clusters-dbscan":222,"@turf/clusters-kmeans":235,"@turf/collect":245,"@turf/combine":252,
						"@turf/concave":254,"@turf/convex":267,"@turf/destination":286,"@turf/difference":289,"@turf/dissolve":298,
						"@turf/distance":373,"@turf/envelope":376,"@turf/explode":381,"@turf/flatten":384,
						"@turf/flip":387,"@turf/great-circle":390,"@turf/helpers":392,"@turf/hex-grid":393,
						"@turf/idw":398,"@turf/inside":414,"@turf/interpolate":416,"@turf/intersect":454,"@turf/invariant":458,
						"@turf/isobands":459,"@turf/isolines":475,"@turf/kinks":485,"@turf/line-arc":487,"@turf/line-chunk":497,
						"@turf/line-distance":515,"@turf/line-intersect":520,"@turf/line-offset":534,"@turf/line-overlap":539,
						"@turf/line-segment":584,"@turf/line-slice":598,"@turf/line-slice-along":588,"@turf/line-split":626,
						"@turf/linestring-to-polygon":685,"@turf/mask":690,"@turf/meta":699,"@turf/midpoint":700,
						"@turf/nearest":709,"@turf/planepoint":713,"@turf/point-grid":715,"@turf/point-on-line":725,
						"@turf/point-on-surface":751,"@turf/point-to-line-distance":765,"@turf/polygon-tangents":799,
						"@turf/polygon-to-linestring":802,"@turf/polygonize":805,"@turf/random":819,"@turf/rewind":821,
						"@turf/rhumb-bearing":827,"@turf/rhumb-destination":839,"@turf/rhumb-distance":852,
						"@turf/sample":865,"@turf/sector":867,"@turf/simplify":886,"@turf/square":900,
						"@turf/square-grid":893,"@turf/tag":904,"@turf/tesselate":907,"@turf/tin":910,
						"@turf/transform-rotate":912,"@turf/transform-scale":956,
						"@turf/transform-translate":1008,"@turf/triangle-grid":1024,"@turf/truncate":1029,
						"@turf/union":1031,"@turf/unkink-polygon":1033,"@turf/within":1048}],2:[function(t,e,n){var i=t("@turf/distance"),
						r=t("@turf/helpers").point,o=t("@turf/bearing"),s=t("@turf/destination");
						e.exports=function(t,e,n){var a;if("Feature"===t.type)a=t.geometry.coordinates;
						else{if("LineString"!==t.type)throw new Error("input must be a LineString Feature or Geometry");
						a=t.coordinates}for(var u=0,l=0;l<a.length&&!(e>=u&&l===a.length-1);l++){
							if(u>=e){var c=e-u;if(c){var f=o(a[l],a[l-1])-180;
								return s(a[l],c,f,n)}
								return r(a[l])}u+=i(a[l],a[l+1],n)}
								return r(a[a.length-1])}},
								{"@turf/bearing":3,"@turf/destination":5,"@turf/distance":8,
								"@turf/helpers":11}],3:[function(t,e,n){function i(t,e,n)
									{if(!0===n)
										return r(t,e);var i=Math.PI/180,s=180/Math.PI,a=o(t),u=o(e),l=i*a[0],
										c=i*u[0],f=i*a[1],h=i*u[1],p=Math.sin(c-l)*Math.cos(h),
										d=Math.cos(f)*Math.sin(h)-Math.sin(f)*Math.cos(h)*Math.cos(c-l);return s*Math.atan2(p,d)}
										function r(t,e){var n=i(e,t);return n=(n+180)%360}var o=t("@turf/invariant").getCoord;e.exports=i},
										{"@turf/invariant":4}
										],4:[function(t,e,n)
										{function i(t){if(!t)throw new Error("obj is required");
										var e=r(t);
										if(e.length>1&&"number"==typeof e[0]&&"number"==typeof e[1])
											return e;
										throw new Error("Coordinate is not a valid Point")}
										function r(t){if(!t)throw new Error("obj is required");
										var e;
										if(t.length?e=t:t.coordinates?e=t.coordinates:t.geometry&&t.geometry.coordinates&&(e=t.geometry.coordinates),e)
											return o(e),e;
										throw new Error("No valid coordinates")}
										function o(t){if(t.length>1&&"number"==typeof t[0]&&"number"==typeof t[1])return!0;
										if(Array.isArray(t[0])&&t[0].length)return o(t[0]);
										throw new Error("coordinates must only contain numbers")}
										function s(t,e,n){if(!e||!n)throw new Error("type and name required");
										if(!t||t.type!==e)
											throw new Error("Invalid input to "+n+": must be a "+e+", given "+t.type)}
										function a(t,e,n){if(!t)
											...
											function u(t,e,n){if(!t)throw new Error("No featureCollection passed");
											...
											for(var i=0;i<t.features.length;i++){var r=t.features[i];if(!r||"Feature"!==r.type||!r.geometry)
												throw new Error("Invalid input to "+n+", Feature with geometry required");
